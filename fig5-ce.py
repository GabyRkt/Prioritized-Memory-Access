...
def plot_fig5ce( nb_sims : int = 100 ) :
    ...
    # starting a plot, divided into 4 quadrants
    ...
    y_forward = [ 100*(x1_forward - x1_forward)/x1_forward , 100*(x4_forward - x1_forward)/x1_forward]
    y_backward = [ 100*(x1_backward - x1_backward)/x1_backward , 100*(x4_backward - x1_backward)/x1_backward]
    ...
    y_forward = [ 100*(x1_forward - x1_forward)/x1_forward  , 100*(x0_forward - x1_forward)/x1_forward]
    y_backward = [ 100*(x1_backward - x1_backward)/x1_backward , 100*(x0_backward - x1_backward)/x1_backward]
